...
<!-- CONTENT -->
    ...
    <a class="navbar-brand" href="#"><b>&nbsp;&nbsp;SISTEM KANTIN</b></a>
            ...
            <a class="topnav2" href="viewsupplier.php">Supplier</a>
    ...
    <tbody>
        <?php
        $query = "SELECT * FROM tb_supplier ORDER BY idsupplier ASC";
        ...
        ?>
            ...
            <tr>
                ...
                <td align="center">
                    <a href="../edit/editsupplier.php?idsupplier=<?= $row['idsupplier']; ?>">
                    <button class="btn btn-primary btn-sm">Edit</button></a> 
                    <!-- | --><br/>
                    <a href="../delete/deletesupplier.php?idsupplier=<?php echo $row['idsupplier']; ?>"
    ...
    <a href="../add/addsupplier.php"><button class="btn btn-primary">Tambah</button></a>
    <a href="../cetak/laporan_supplier.php"><button class="btn btn-primary">Cetak</button></a>
    </div>
    <div class="col-1">
    </div>
	</div>
