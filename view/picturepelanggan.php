...
<!-- CONTENT -->
    ...
    <table>
        <tr><td>
    <a href="javascript:window.print()"><button type="button" class="btn btn-primary">&nbsp;&nbsp;PRINT&nbsp;&nbsp;<i class="fas fa-print"></i></button></a>
        </td>
        <td>&nbsp;</td>
        <td>
    <a href="../view/viewpelanggan.php"><button type="button" class="btn btn-secondary">&nbsp;BACK&nbsp;<i class="fas fa-sign-out-alt"></i></button></a>
        ...
        <table height="50px" width="100%">
            <tr><td width="26px"></td>
                <td align="left">
                <button class="btn btn-sm sus btn-light borrrder" disabled><b>ADMIN</b></button>
            </td><td width="1%"></td>
        </tr>
        </table>
</nav>
