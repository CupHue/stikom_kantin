...
<!-- CONTENT -->
    ...
    <br>
        ...
        <h2>Proses Tambah Supplier</h2><br>
            
        <form method="POST" action="proses_addsupplier.php" enctype="multipart/form-data" >
        <section class="base">
        <table width="75%">
            <tr><td width="30%">
          <div>
              <label>ID Supplier</label></td><td>
              <input type="text" name="idsupplier" placeholder=" HARUS UNIK - TIDAK BOLEH SAMA " autofocus="" />
          </div>
            </td></tr>
            <tr><td>
          <div>
              <label>Nama Perusahaan</label></td><td>
