...
<!-- CONTENT -->
    ...
    <br>
        ...
        <h2>Proses Tambah Karyawan</h2><br>
            
        <form method="POST" action="proses_addkaryawan.php" enctype="multipart/form-data" >
        <section class="base">
        <table width="75%">
            <tr><td width="30%">
          <div>
              <label>ID Karyawan</label></td><td>
              <input type="text" name="idkaryawan" placeholder=" HARUS UNIK - TIDAK BOLEH SAMA " autofocus="" />
          </div>
            </td></tr>
            <tr><td>
          <div>
              <label>Nama Karyawan</label></td><td>
