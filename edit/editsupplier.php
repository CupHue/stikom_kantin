...
include '../koneksi.php';
    ...
    if (isset($_GET['idsupplier'])) {
        ...
        $query = "SELECT * FROM tb_supplier WHERE idsupplier='$idsupplier'";
        ...
        $data = mysqli_fetch_assoc($result);
            ...
            if (!count($data)) {
                echo "<script>alert('Data Tidak Di Temukan Pada Database.');window.location='../view/viewsupplier.php';</script>";
            }
    } else {
        // apabila tidak ada data GET id , akan di redirect ke viewpelanggan.php
        echo "<script>alert('Masukan Data Id.');window.location='../view/viewsupplier.php';</script>";
    }
?>
...
<!-- CONTENT -->
    ...
    <a href="../view/viewsupplier.php"><button type="button" class="btn btn-secondary">&nbsp;&nbsp;BACK&nbsp;&nbsp;<i class="fas fa-sign-out-alt"></i></button></a>
    </div>
    ...
    <br>
        ...
        <form method="POST" action="proses_editsupplier.php" enctype="multipart/form-data" >
        <section class="base">

            <!-- MENAMPUNG NILAI ID PRODUK YANG AKAN DI EDIT -->
            <input name="idsupplier" value="<?php echo $data['idsupplier']; ?>" hidden />
            <div>
                <label>Nama Perusahaan</label>
                <input type="text" name="perusahaan" value="<?php echo $data['perusahaan']; ?>" autofocus="" required="" />
            </div>
            <div>
                <label>Telepon</label>
