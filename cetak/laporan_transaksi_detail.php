...
<!-- CONTENT -->
    ...
    <a class="navbar-brand" href="#"><b>&nbsp;&nbsp;SISTEM KANTIN</b></a>
            ...
            <a href="../view/viewtransaksi.php"><button type="button" class="btn btn-secondary">&nbsp;&nbsp;BACK&nbsp;&nbsp;<i class="fas fa-sign-out-alt"></i></button></a>
    </div>
    ...
    <br/><br/>
        ...
        <thead class="table bg-dark">
                ...
                <!-- PHP SELESAI -->
                    ...
                    <div class="col-sm-5">
                        <select name="idmenu">
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ?>
                                <option value="<?= $row['idmenu'] ?>"><?= $row['idmenu']?>    ||   <?= $row['namamenu']?></option>
                                <?php
                            }
                            ?>
                        </select>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-5">
                            <input type="number" min="1" name="jumlah" class="form-control" id="inputText3">
                        </div>
                    </div>
            ...
            ?>
                    ...
                    <div class="row mb-2">
                        <div>
                            <td><a href="../add/transaksi_detail.php?idtransaksi=<?= $idtransaksi;?>&input_menu=true" type="submit" name="Selanjutnya" class="btn btn-primary">Tambah</a></td>
